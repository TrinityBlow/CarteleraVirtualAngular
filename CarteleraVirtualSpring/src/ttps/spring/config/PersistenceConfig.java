...
public class PersistenceConfig {
	...
	private static final String MODEL_PACKAGE = "ttps.spring.modelCartelera";
	...
	public DataSource dataSource() {
		...
		driverManagerDataSource.setUrl("jdbc:mysql://localhost:3306/cartelera_virtual?serverTimezone=UTC");
